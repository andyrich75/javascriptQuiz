...
function renderTime(){
  ...
  var outofTime = function() {
    clearLastAnswer();
    feedback.textContent = "You ran out of time! No points for you."
    score = 0;
...
function runQuiz(){
    ...
    if(currentQuestion === questionArray.length){
      ...
      //grab the user clicked and check it against the answer
...
function resetQuiz(){
  ...
  //redirect on submit to the highscore html
  function redirect(){
